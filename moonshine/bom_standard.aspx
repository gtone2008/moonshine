<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="bom_standard.aspx.cs" Inherits="moonshine.bom_standard" %>

<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <ol class="breadcrumb">
        <li><a href="#">Product</a></li>
        <li class="active">bom_standard</li>
    </ol>
