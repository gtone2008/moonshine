...
namespace moonshine
{
    public partial class RequestsAll : System.Web.UI.Page
    {
        ...
        protected void gvAll_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (e.Row.RowState == DataControlRowState.Normal || e.Row.RowState == DataControlRowState.Alternate)
                {
                    ...
                    Label lb1 = e.Row.Cells[9].Controls[1] as Label;//TaskStatus
                    Label lb2 = e.Row.Cells[11].Controls[1] as Label;
                    if (e.Row.Cells[7].Text == "Closed")
                    {
                        if (lb1.Text == "")
                        {
        ...
        protected void gvAll_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            if (gvAll.Rows[e.RowIndex].Cells[7].Text == "Closed")
            {
