...
namespace moonshine
{
    ...
    {
        private string str1 = "SELECT ps_id, ps_name, ps_standard, ps_pic, ps_useArea ,v_amount FROM product_no_standard left join v_no_product_standard on ps_id=v_bs_name where 1=1 ";
        private string str2 = "insert into product_no_standard(ps_id,ps_name,ps_standard,ps_pic, ps_useArea) values('{0}', '{1}','{2}','{3}','{4}')";
        private string str3 = "SELECT ps_id FROM product_no_standard where  ps_id ='{0}' ";
