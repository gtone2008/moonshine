        ...
        <div class="container-fluid body-content">
            ...
            <div class="col-sm-12 panel panel-default ">
                <div class="panel-body">
                    P/N:<input value="<%=Request["txtbase"]%>" type="text" name="txtbase" id="txtbase" placeholder="请输入PN号" />
                    Description:<input value="<%=Request["txtdesc"]%>" type="text" name="txtdesc" id="txtdesc" placeholder="请输入描述(关键词查询)" />
