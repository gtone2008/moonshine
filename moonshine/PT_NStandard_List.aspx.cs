...
namespace moonshine
{
    ...
    {
        private string str1 = "SELECT ps_id, ps_name, ps_standard, ps_pic, ps_useArea ,v_amount FROM product_no_standard join v_no_product_standard on ps_id=v_bs_name where 1=1 ";
