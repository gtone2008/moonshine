...
namespace moonshine.Util
{
    public class role
    {
        //enum roles_group { admin, material, request, aprive, guest };//管理员、物料员、申请人、审批人、客户
        ...
        //    if (mysdr1.Read())
        //    {
        //        string po = mysdr1.GetValue(0).ToString();
        //        if (po=="admin"||po=="guest")
        //        {
        //            is_check = true;
        //        }
        //        else
        ...
        public static string power()
        {
            ...
            if (mysdr1.Read())
            {
                return mysdr1.GetValue(0).ToString();
            }
            else
                return "";
        }
