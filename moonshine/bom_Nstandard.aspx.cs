...
namespace moonshine
{
    ...
    {
        private string str1 = "SELECT bom_no_standard.bs_name, bom_no_standard.basic_id, description,bom_no_standard.bs_qty,basic_data.price,bs_qty * price as amount from bom_no_standard left join basic_data on bom_no_standard.basic_id=basic_data.basic_id ";
        private string str11 = "insert into bom_no_standard(bs_name, basic_id, bs_qty) values ('{0}','{1}',{2})";//加入BOM
        private string str2 = "SELECT description,spec FROM basic_data where 1=1 and basic_id='{0}' ";// //下拉菜单PN号取描述
        private string str21 = "SELECT ps_name FROM product_no_standard where 1=1 and ps_id='{0}' ";// //下拉菜单Item号取name
        private string str3 = "SELECT basic_id FROM basic_data  "; //下拉菜单PN号
        private string str4 = "SELECT ps_id FROM product_no_standard  "; //下拉菜单item号
        private string str5 = "delete from bom_no_standard ";
